...
sp1 = 'log_richness_plus_1'
# tro = 'all'
year=2020
Di='log_richness_plus_1'
...
for tro in niche_list:
    for stemflow_params in ['10_40_20_50','10_100_30_80']:
        ...
        data = pd.read_csv(os.path.join(pred_saving_path, f'log_richness_plus_1_h3_05_year2020_{tro}_{stemflow_params}_smoothed_with_diff.csv'))
        half = np.nanquantile(data['delog_log_richness_plus_1_diff'].abs(), 0.95)
        make_sample_gif(data, f'../../data/D01.AdaSTEM_Model/GIF/birdwave_index_{tro}_{stemflow_params}.gif',
                            col='delog_log_richness_plus_1_diff', log_scale = False,
                            ...
                            lng_size = 360, lat_size = 180, dpi=100, fps=30, cmap='coolwarm')
