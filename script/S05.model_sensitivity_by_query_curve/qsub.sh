...
target_var_list=("mean_NDVI" "delta_NDVI" "tmean" "tmax" "tmin")
# Initialize counter
counter=0
    ...
    do
        for niche in "${niches[@]}"
            do
                ...
                echo """
                cd \$PBS_O_WORKDIR
                python -u GreenWave_BirdWave_correlation_BYM2_multi_niches_and_season.py ${niche} ${target_var} > ./log_file/${niche}_${target_var}.log 2>&1
