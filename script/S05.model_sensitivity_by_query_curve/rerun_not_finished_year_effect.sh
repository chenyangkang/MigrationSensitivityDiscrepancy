#python get_not_finished_year_effect.py
wait
sleep 1


# Define node specifications for 4 different chunks
nodes_specifications=("nodes=cu04:ppn=4,mem=50G" "nodes=cu05:ppn=4,mem=50G") # "nodes=cu03:ppn=4,mem=50G" "nodes=cu07:ppn=4,mem=50G" "nodes=cu06:ppn=4,mem=50G" "nodes=cu08:ppn=4,mem=50G" "nodes=cu09:ppn=4,mem=50G"
